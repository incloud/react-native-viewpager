...
declare const ViewPagerBase: ReactNative.Constructor<
  ReactNative.NativeMethodsMixin
> &
  typeof ViewPagerComponent;
export class ViewPager extends ViewPagerBase {
  /**
...
export interface IndicatorViewPagerProps extends ViewProperties {
...
export interface PagerDotIndicatorProps extends ViewProperties {
  pageCount: number;
